...
export default function Header() {
    ...
    return (
        <div className={`flex justify-between ${primaryBgClr} px-8 py-4 font-['Space_Grotesk']`}>
            ...
            <Navbar />
            <Button children={"Resume"} className={`${resBtnTextClr} ${resBtnBgClr} flex justify-center items-center w-28 h-10 rounded-md font-bold cursor-pointer hover:bg-emerald-200/20 transition-colors duration-300`} />
        </div>
    );
}
