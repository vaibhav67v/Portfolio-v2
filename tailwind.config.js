    ...
    theme: {
        extend: {
            ...
            boxShadow: {
                ...
                "depth": "inset 0 1px 2px hsl(0 0% 100% / 0.1), 0 2px 2px hsl(0 0% 0% / 0.4)",
                "depth-softer": "inset 0 1px 2px hsl(0 0% 100% / 0.1), 0 1px 1px hsl(0 0% 0% / 0.4)",
                "depth-hover": "inset 0 1px 2px hsl(0 0% 100% / 0.15), 0 4px 10px hsl(0 0% 0% / 0.5), 0 4px 20px hsl(var(--color-primary)/ 0.3)",
                input: "inset 0 1px 2px hsl(0 0% 0% / 0.5), inset 0 -1px 2px hsl(0 0% 100% / 0.05)",
